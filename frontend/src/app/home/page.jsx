...
export default function HomePage() {
  ...
  const handleCreateRoom = () => {
    ...
    window.location.href = `/editor?roomId=${newRoomId}&username=${username}`;
  };
  ...
  const features = [
    {
      ...
      description: "Edit code live with your team using synced updates.",
      color: "from-[#FF6B6B] to-[#FFD93D]",
    },
    {
      icon: MessageSquare,
      title: "Live Chat",
      description: "Talk instantly with smart message indicators.",
      color: "from-[#4ECDC4] to-[#5561FF]",
    },
    {
      icon: Bot,
      title: "AI Coding Assistant",
      description: "Get intelligent help for debugging & explanations.",
      color: "from-[#845EC2] to-[#FF9671]",
    },
    {
      icon: FolderOpen,
      title: "Session Management",
      description: "Create, share, and organize collaborative sessions.",
      color: "from-[#00C9A7] to-[#92FE9D]",
    },
    {
      icon: Lock,
      title: "Secure Authentication",
      description: "Stay protected with end-to-end encrypted sessions.",
      color: "from-[#F72585] to-[#7209B7]",
    },
    {
      icon: Sparkles,
      title: "Beautiful UI",
      description: "Smooth gradients, neon effects, and elegant design.",
      color: "from-[#00BBF9] to-[#FEE440]",
    },
  ];
    ...
    <section className="relative text-center py-24 px-6 bg-gradient-to-b from-[#0A0A18] via-[#141022] to-[#1A162B] min-h-screen overflow-hidden">
      ...
      <div className="max-w-md mx-auto bg-[#141022]/70 p-8 rounded-3xl backdrop-blur-xl border border-[#2E5BFF]/30 shadow-[0_0_50px_-10px_rgba(46,91,255,0.5)] mb-20 transition-transform hover:scale-[1.02]">
        ...
        <input
          ...
          className="w-full p-3 mb-6 rounded-lg bg-[#1E1A2E] text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#00C9A7]/60 transition-all"
        />
